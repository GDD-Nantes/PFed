 ...
 * @author khiyari-s
 */
public class TestPruningLogsV2 {
	...
	String fedMinimalPathQueriesFile = "../../../fedMinimalPathQueriesFile.txt";
...
System.out.println();
   ...
   //     Config.initialize();
	...
	//        PLpath.genFedLightServiceSage(sparqlEndpoint1, sparqlEndpoint2, genFedLightFile);
        System.out.println("----------------------------------------------");
//PLpath.joinPredicatesFromMinimalPath(fedMinimalPathQueriesFile);
//PLpath.genFedLightServiceSage(genFedMediumPathFile, sparqlEndpoint2);

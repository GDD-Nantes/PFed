...
public class FedSumGenerator {
	 ...
	 */
	public void generateSummaries(List<String> endpoints, String graph, int start) throws IOException, RepositoryException, MalformedQueryException, QueryEvaluationException{
		for(String endpoint:endpoints)
		{
			System.out.println("generating summaries for: " + endpoint);
			ArrayList<String> lstPred = getPredicates(endpoint,graph);
// 			Path filepath = new File("../listPredDBpedia").toPath();
// 			ArrayList<String> lstPred = new ArrayList<String>(Files.readAllLines(filepath));
			...
			bw.newLine();
			for(int i =start ;i<lstPred.size();i++)
			{
